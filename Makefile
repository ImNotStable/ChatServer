...
SERVER_CFLAGS = $(CFLAGS) -DMAX_CLIENTS=100 -DSERVER_PORT=8888 -DBUFFER_SIZE=4096
...
$(BUILD_DIR)/libcommon.a: $(wildcard $(COMMON_DIR)/*.c)
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -DMAX_USERNAME_LEN=32 -DMAX_PASSWORD_LEN=64 -DSERVER_PORT=8888 -DBUFFER_SIZE=4096 -c $(COMMON_DIR)/logger.c -o $(BUILD_DIR)/logger.o
	$(CC) $(CFLAGS) -DMAX_USERNAME_LEN=32 -DMAX_PASSWORD_LEN=64 -DSERVER_PORT=8888 -DBUFFER_SIZE=4096 -c $(COMMON_DIR)/protocol.c -o $(BUILD_DIR)/protocol.o
